...
vim.keymap.set({ "v", "n" }, "ga", function() require("actions-preview").code_actions() end)
...
vim.keymap.set('n', '<leader><space>',
	function() return require('telescope.builtin').buffers { file_ignore_patterns = { "lean://" } } end,
...
require('nvim-treesitter').install({ 'c', 'cpp', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript',
	'vimdoc', 'vim', 'bash', 'typst', 'mail' }):wait(300000) -- wait max. 5 minutes
